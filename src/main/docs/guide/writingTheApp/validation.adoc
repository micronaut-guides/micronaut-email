...
----
include::{sourceDir}/src/test/java/example/micronaut/MailControllerValidationTest.java[]
----
...
include::{sourceDir}/src/main/java/example/micronaut/EmailCmd.java[tag=clazz]
